...
# set_false_path -from [get_cells "x_heep_system_i/core_v_mini_mcu_i/ao_peripheral_subsystem_i/obi_spi_slave_i/u_slave_sm/u_spiregs/reg*_reg[*]/*"] -to [get_cells "x_heep_system_i/core_v_mini_mcu_i/ao_peripheral_subsystem_i/obi_spi_slave_i/u_obiplug/tx_counter_reg*"]
